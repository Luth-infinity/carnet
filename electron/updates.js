...
const REPO = 'Luth-infinity/carnet';
const LATEST = `https://api.github.com/repos/${REPO}/releases/latest`;

// Un carnet de notes reste ouvert des jours : une vérification au démarrage
// ne suffit pas. On repasse toutes les deux heures, et à chaque retour sur la
// fenêtre, comme dans Hublink.
